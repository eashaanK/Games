...
public abstract class Tile {
	...
	public static final Tile SAND = new BasicTile(4, 3, 0, Colors.get(-1, 542  , 321, -1), 0xFF00FF00);
	public static final Tile LAVA = new AnimatedTile(5, new int[][]{{3, 5}, {4, 5}, {5, 5}, {4, 5}}, Colors.get(550, 500, 400, -1), 0xFF0000FF, 500);
