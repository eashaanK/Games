...
import com.ek.components.BaseLight;
import com.ek.components.DirectionalLight;
import com.ek.components.PointLight;
import com.ek.components.SpotLight;
import com.ek.core.*;
...
public class Shader
{
	...
	private static String LoadShader(String fileName)
	{
		...
		try
		{
			shaderReader = new BufferedReader(new FileReader("PotentialRPGGame/shaders/" + fileName));
			String line;
