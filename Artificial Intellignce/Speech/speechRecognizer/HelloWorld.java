...
public class HelloWorld {
    ...
    static void swapGrammar(String newGrammarName) 
      ...
      //  cm.setProperty("jsgfGrammar", "grammarName", newGrammarName);
	        linguist.allocate();
	    cm.setGlobalProperty("grammarName", newGrammarName);
	    linguist.allocate();
...
/*public static void main(String[] args) {
    ...
    if (args.length > 0) {
    	...
    	File file = new File("Artificial Intellignce/Speech/helloworld.config.xml");
    	System.out.println(file.getAbsolutePath());
new ConfigurationManager("", 1);
    	cm = new ConfigurationManager(HelloWorld.class.getResource(file.getAbsolutePath()));
    }
        ...
        while (true) {
            ...
            edu.cmu.sphinx.result.Result result = recognizer.recognize();
