...
public class World {
	...
	//private static int largestFeature = (int)(Math.random() *Terrain.MAX_HEIGHT);
	//private static double persistence = Math.random() * 0.35;	
	public static  SimplexNoise noise1 = new SimplexNoise((int)(Math.random() *Terrain.MAX_HEIGHT), Math.random() * 0.35, Ref.SEED);
	
	public static  SimplexNoise noise2 = new SimplexNoise((int)(Math.random() *Terrain.MAX_HEIGHT), Math.random() * 0.35, Ref.SEED);
